...
<header>
	...
	<nav id="top">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<strong>Olatunde Ajibayo Ewuola</strong>
				</div>
				<div class="col-md-6">
    ...
    <nav id="menu" class="navbar navbar-default" role="navigation">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#">
				<div class="logo"><span>Olatunde Ajibayo Ewuola</span></div>
			</a>
		</div>
	...
	<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">My Projects <i class="fa fa-arrow-circle-o-down"></i></a>
	...
	<div id="page-content" class="index-page">
		<div class="clearfix no-gutter">
			<div id="main-content" class="col-md-9 fix-right">
				<div class="tag-title">
					<h2><i class="fa fa-tag"></i> Lifestyle</h2>
				</div>
				<div class="gutter-7px">
					<div class="col-md-4">
						...
						<article>
							<div class="entry-header">
								<div class="grid-cat"><a href="#">Music</a></a></div>
								<h3 class="entry-title"><a href="#">Marshall, Will, and Holly on a Routine Expedition</a></h3>
								<span><i class="fa fa-heart"></i> 1,200 / <i class="fa fa-calendar"></i> 25/3/2015 / <i class="fa fa-comment-o"></i> 10 / <i class="fa fa-eye"></i> 945</span>
							</div>
					...
					<div class="col-md-4">
						...
						<article>
							<div class="entry-header">
								<div class="grid-cat"><a href="#">Events</a>,<a href="#"> Music</a></div>
								<h3 class="entry-title"><a href="#">Marshall, Will, and Holly on a Routine Expedition</a></h3>
								<span><i class="fa fa-heart"></i> 1,200 / <i class="fa fa-calendar"></i> 25/3/2015 / <i class="fa fa-comment-o"></i> 10 / <i class="fa fa-eye"></i> 945</span>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.html"><img src="images/14.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.html">More...</a>
							</div>
					...
					<div class="col-md-4">
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.html"><img src="images/5.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.html">More...</a>
							</div>
						...
						<article>
							<div class="entry-header">
								<div class="grid-cat"><a href="#">Lifestyle</a>,<a href="#"> Events</a></div>
								<h3 class="entry-title"><a href="#">Marshall, Will, and Holly on a Routine Expedition</a></h3>
								<span><i class="fa fa-heart"></i> 1,200 / <i class="fa fa-calendar"></i> 25/3/2015 / <i class="fa fa-comment-o"></i> 10 / <i class="fa fa-eye"></i> 945</span>
							</div>
							<div class="post-thumbnail-wrap"><a href="single.html"><img src="images/9.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.html">More...</a>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.html"><img src="images/12.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.html">More...</a>
							</div>
						...
						<article>
							...
							<div class="post-thumbnail-wrap"><a href="single.html"><img src="images/15.jpg" /></a></div>
							<div class="entry-content">
								<p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known. High on the rapids, it struck their tiny raft! And plunged them down a thousand feet below</p>
								<a href="single.html">More...</a>
							</div>
	...
	<footer>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-footer footer-1">
						<div class="footer-heading"><h1><span style="color: #fff;">Olatunde Ajibayo Ewuola</span></h1></div>
						<div class="content">
		...
		<div class="copy-right">
			<p>Copyright 2016 - Designed by <a href="https://www.eolatunde.ga">Eolatunde</a></p>
		</div>
	</footer>
	<!-- Footer -->
