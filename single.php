			...
			<div id="main-content" class="col-md-8 fix-right">
				<article class="single-post">
					<div class="entry-header">
						<h1 class="entry-title"><a href="#">Marshall, Will, and Holly on a Routine Expedition</a></h1>
					...
					<div class="post-thumbnail-wrap"><img src="images/8.jpg" /></div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="wrap-vid">
									...
									<h3 class="vid-name"><a href="#">Post's Name</a></h3>
									<div class="info">
